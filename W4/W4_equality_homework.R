...
# read csv data
data<-read.csv("E:/GIS/W4/HDR23-24_Composite_indices_complete_time_series.csv")
...
# read GeoJSON data
geo_data <- st_read("E:/GIS/W4/World_Countries_(Generalized)_9029012925078512962.geojson")
